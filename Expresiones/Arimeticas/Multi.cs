...
namespace compipascal2.Expresiones.Arimeticas
{
    class Multi : Expresion
    {
        ...
        public Multi(Expresion izq, Expresion der, int linea, int columna)
        {
            this.izq = izq;
            this.der = der;
            Linea = linea;
        ...
        public Retorno resolver(Entorno ent)
        {
            ...
            throw new Errorp(this.Linea, this.Columna, "Semantico", "No se Puede Multiplicar un Tipo " + izqR.type.type + " Con el tipo " + derR.type.type, ent.nombre);
        }
    }
}
