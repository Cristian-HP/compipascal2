...
namespace compipascal2.Expresiones.Arimeticas
{
    class Div : Expresion
    {
        ...
        public Div(Expresion izq, Expresion der, int linea, int columna)
        {
            this.izq = izq;
            this.der = der;
            Linea = linea;
        ...
        public Retorno resolver(Entorno ent)
        {
            ...
            if(derR.getValor() == "0")
            {
                throw new Errorp(Linea,Columna,"Semantico","Indefinicion No es posible la division entre 0 ",ent.nombre);
            }
            ...
            throw new Errorp(this.Linea, this.Columna, "Semantico", "No se Puede Dividir un Tipo " + izqR.type.type + " Con el tipo " + derR.type.type, ent.nombre);
    }
}
}
